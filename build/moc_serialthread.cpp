...
QT_MOC_LITERAL(5, 42, 10) // "starThread"

    },
    "SerialThread\0sendSerialData\0\0str\0"
    "readData\0starThread"
};
...
void SerialThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SerialThread::sendSerialData)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void SerialThread::sendSerialData(QString _t1)
{
