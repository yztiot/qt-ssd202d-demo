...
QT_MOC_LITERAL(1, 6, 12), // "getSoundFile"
QT_MOC_LITERAL(2, 19, 0), // ""
QT_MOC_LITERAL(3, 20, 12) // "getSoundPath"

    },
    "Sound\0getSoundFile\0\0getSoundPath"
};
...
void Sound::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: { QStringList _r = _t->getSoundFile();
            if (_a[0]) *reinterpret_cast< QStringList*>(_a[0]) = std::move(_r); }  break;
        case 1: { QString _r = _t->getSoundPath();
